...
internal class InitialData
{
    ...
    new List<Customer>
    {
        Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "Marwa", "Marwa@gmail.com"),
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("Marwa", "Mohamed", "Marwa@gmail.com", "Bahcelievler No:4", "Turkey", "Istanbul", "38050");
            var address2 = Address.Of("john", "doe", "john@gmail.com", "Broadway No:1", "England", "Nottingham", "08050");

            var payment1 = Payment.Of("Marwa", "5555555555554444", "12/28", "355", 1);
